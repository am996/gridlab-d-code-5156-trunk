...
#ifndef _my_microturbineWrapper_h_
#define _my_microturbineWrapper_h_
...
namespace staff
{
  ...
  class my_microturbineImpl;

  //! my_microturbine service wrapper
  class my_microturbineWrapper: public staff::ServiceWrapper
  {
  public:
    //! initializing constructor
    /*! \param  pComponent - service's component
    */
    my_microturbineWrapper(staff::Component* pComponent);

    //! destructor
    virtual ~my_microturbineWrapper();
...
#endif // _my_microturbineWrapper_h_
