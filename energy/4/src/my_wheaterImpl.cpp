...
{
std::cout<<"Water Heater Service WHcreate"<<std::endl;
...
{
std::cout<<"Water Heater Service WHinit"<<std::endl;
...
{
std::cout<<"Water Heater Service WHsync"<<std::endl;
  int tResult;
...
{
std::cout<<"Water Heater Service WHcommit"<<std::endl;
 	Tw_old = Tw;
...
{
std::cout<<"Water Heater Service WHtank_state"<<std::endl;
...
{
std::cout<<"Water Heater Service WHps"<<std::endl;
...
{
std::cout<<"Water Heater Service WHsttt"<<std::endl;
...
{
std::cout<<"Water Heater Service WHscmals"<<std::endl;
...
{
std::cout<<"Water Heater Service WHdhdt"<<std::endl;
  ...
  double dhdt_now = WHdhdt(h);
	...
	std::cout<<"Water Heater Service WHds"<<std::endl;
...
{
std::cout<<"Water Heater Service WHakW"<<std::endl;
...
{
std::cout<<"Water Heater Service WHnt1n"<<std::endl;
...
{
std::cout<<"Water Heater Service WHnt2z"<<std::endl;
...
{
std::cout<<"Water Heater Service WHgt"<<std::endl;
