...
#ifndef _my_wind_turbineWrapper_h_
#define _my_wind_turbineWrapper_h_
...
namespace staff
{
  ...
  class my_wind_turbineImpl;

  //! my_wind_turbine service wrapper
  class my_wind_turbineWrapper: public staff::ServiceWrapper
  {
  public:
    //! initializing constructor
    /*! \param  pComponent - service's component
    */
    my_wind_turbineWrapper(staff::Component* pComponent);

    //! destructor
    virtual ~my_wind_turbineWrapper();
...
#endif // _my_wind_turbineWrapper_h_
