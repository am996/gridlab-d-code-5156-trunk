/** $Id: micro_service.h,v 1.0 2008/07/18
	Copyright (C) 2008 Battelle Memorial Institute
	@file micro_service.h
	@addtogroup micro_service

 @{  
 **/

#ifndef _micro_service_H
#define _micro_service_H
...
class micro_service : public gld_object
{
private:
...
public:
	...
	//note micro_service panel will always operate under the SUPPLY_DRIVEN generator mode
