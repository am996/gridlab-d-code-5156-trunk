/** $Id: wind_service.h 4738 2014-07-03 00:55:39Z dchassin $
	Copyright (C) 2008 Battelle Memorial Institute
	@file wind_service.h
	@addtogroup wind_service
	@ingroup generators

 @{  
 **/
#ifndef _wind_service_H
#define _wind_service_H
...
class wind_service : public gld_object
{
private:
